 ...
 *         &lt;element name="operand" type="{http://ss.yahooapis.jp/V5}BiddingStrategy" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Operation
{
    ...
    protected List<BiddingStrategy> operand;
    ...
    public List<BiddingStrategy> getOperand() {
        if (operand == null) {
            operand = new ArrayList<BiddingStrategy>();
        }
        return this.operand;
    }
