 ...
 *         &lt;element name="operand" type="{http://ss.yahooapis.jp/V5}CampaignTarget" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Operation
{
    ...
    protected List<CampaignTarget> operand;
     ...
     * 
     */
    public List<CampaignTarget> getOperand() {
        if (operand == null) {
            operand = new ArrayList<CampaignTarget>();
        }
        return this.operand;
    }
