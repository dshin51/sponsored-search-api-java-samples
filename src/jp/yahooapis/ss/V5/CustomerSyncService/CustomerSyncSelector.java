 ...
 *         &lt;element name="eventTypes" type="{http://ss.yahooapis.jp/V5}EventType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="sourceTypes" type="{http://ss.yahooapis.jp/V5}SourceType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="dateRange" type="{http://ss.yahooapis.jp/V5}DateRange" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CustomerSyncSelector {
    ...
    public List<SourceType> getSourceTypes() {
        if (sourceTypes == null) {
            sourceTypes = new ArrayList<SourceType>();
        }
