 ...
 *         &lt;element name="operand" type="{http://ss.yahooapis.jp/V5}CampaignFeedList" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends Operation
{
    ...
    protected List<CampaignFeedList> operand;
     ...
     * 
     */
    public List<CampaignFeedList> getOperand() {
        if (operand == null) {
            operand = new ArrayList<CampaignFeedList>();
        }
        return this.operand;
    }
