 ...
 * 
 */
@WebServiceClient(name = "ConversionTrackerService", targetNamespace = "http://ss.yahooapis.jp/V5", wsdlLocation = "https://sandbox.ss.yahooapis.jp/services/V5.0/ConversionTrackerService?wsdl")
public class ConversionTrackerService
    extends Service
{

    private final static URL CONVERSIONTRACKERSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(jp.yahooapis.ss.V5.ConversionTrackerService.ConversionTrackerService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = jp.yahooapis.ss.V5.ConversionTrackerService.ConversionTrackerService.class.getResource(".");
            url = new URL(baseUrl, "https://sandbox.ss.yahooapis.jp/services/V5.0/ConversionTrackerService?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'https://sandbox.ss.yahooapis.jp/services/V5.0/ConversionTrackerService?wsdl', retrying as a local file");
    ...
    public ConversionTrackerService() {
        super(CONVERSIONTRACKERSERVICE_WSDL_LOCATION, new QName("http://ss.yahooapis.jp/V5", "ConversionTrackerService"));
    }
