 ...
 *         &lt;element name="statuses" type="{http://ss.yahooapis.jp/V5}ConversionTrackerStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="categories" type="{http://ss.yahooapis.jp/V5}ConversionTrackerCategory" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="conversionTrackerTypes" type="{http://ss.yahooapis.jp/V5}ConversionTrackerType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="trackingCodeTypes" type="{http://ss.yahooapis.jp/V5}TrackingCodeType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="dateRange" type="{http://ss.yahooapis.jp/V5}ConversionDateRange" minOccurs="0"/>
