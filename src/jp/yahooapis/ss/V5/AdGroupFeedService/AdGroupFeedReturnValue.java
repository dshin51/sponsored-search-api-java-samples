 ...
 *       &lt;sequence>
 *         &lt;element name="values" type="{http://ss.yahooapis.jp/V5}AdGroupFeedValues" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends ListReturnValue
{
    ...
    protected List<AdGroupFeedValues> values;
     ...
     * {@link AdGroupFeedValues }
     * 
     * 
     */
    public List<AdGroupFeedValues> getValues() {
        if (values == null) {
            values = new ArrayList<AdGroupFeedValues>();
        }
        return this.values;
    }
