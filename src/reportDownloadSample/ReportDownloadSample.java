...
import jp.yahooapis.ss.V5.ReportDefinitionService.*;
import jp.yahooapis.ss.V5.ReportDefinitionService.ReportDateRangeType;
import jp.yahooapis.ss.V5.ReportService.*;
...
public class ReportDownloadSample {
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            //fields
            String[] fieldNames = new String[]{"AVERAGECPC","AVERAGECPM","AVERAGEPOSITION","CLICKS","UNIQUECONVERSIONRATE","TOTALCONVERSIONRATE","UNIQUECONVERSIONS","TOTALCONVERSIONS","TOTALREVENUE","COST","COSTUNIQUECONVERSIONS","COSTTOTALCONVERSIONS","CTR","IMPRESSIONS"};
