package trafficEstimatorSample;

import error.impl.TrafficEstimatorServiceEntityFactory;
import jp.yahooapis.ss.V5.TrafficEstimatorService.*;
...
/**
 * Sample Program for TrafficEstimatorService. Copyright (C) 2012 Yahoo Japan
