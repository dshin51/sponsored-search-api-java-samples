package keywordEstimatorSample;

import error.impl.KeywordEstimatorServiceErrorEntityFactory;
import jp.yahooapis.ss.V5.KeywordEstimatorService.*;
...
/**
 * Sample Program for KeywordEstimatorService. Copyright (C) 2012 Yahoo Japan
