...
import jp.yahooapis.ss.V5.BidLandscapeService.ErrorDetail;

import error.ErrorDetailEntity;
import error.ErrorEntity;
import error.ErrorEntityFactory;

public class BidLandscapeServiceErrorEntityFactory implements ErrorEntityFactory {

    private final List<Error> errors;

    public BidLandscapeServiceErrorEntityFactory(List<Error> errors) {
        this.errors = errors;
    }
