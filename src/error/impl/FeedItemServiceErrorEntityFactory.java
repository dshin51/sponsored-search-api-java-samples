...
import jp.yahooapis.ss.V5.FeedItemService.ErrorDetail;
import error.ErrorDetailEntity;
import error.ErrorEntity;
import error.ErrorEntityFactory;

public class FeedItemServiceErrorEntityFactory implements ErrorEntityFactory {

    private final List<Error> errors;

    public FeedItemServiceErrorEntityFactory(List<Error> errors) {
        this.errors = errors;
    }
