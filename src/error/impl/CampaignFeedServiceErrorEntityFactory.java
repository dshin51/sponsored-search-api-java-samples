...
import jp.yahooapis.ss.V5.CampaignFeedService.Error;
import jp.yahooapis.ss.V5.CampaignFeedService.ErrorDetail;
import error.ErrorDetailEntity;
import error.ErrorEntity;
import error.ErrorEntityFactory;

public class CampaignFeedServiceErrorEntityFactory implements ErrorEntityFactory {

    private final List<Error> errors;

    public CampaignFeedServiceErrorEntityFactory(List<Error> errors) {
        this.errors = errors;
    }
