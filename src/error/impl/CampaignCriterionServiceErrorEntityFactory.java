...
import jp.yahooapis.ss.V5.CampaignCriterionService.ErrorDetail;

public class CampaignCriterionServiceErrorEntityFactory implements ErrorEntityFactory {

    private final List<Error> errors;

    public CampaignCriterionServiceErrorEntityFactory(List<Error> errors) {
        this.errors = errors;
    }
