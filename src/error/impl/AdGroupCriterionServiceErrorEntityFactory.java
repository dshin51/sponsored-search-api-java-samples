...
import jp.yahooapis.ss.V5.AdGroupCriterionService.ErrorDetail;

public class AdGroupCriterionServiceErrorEntityFactory implements ErrorEntityFactory {

    private final List<Error> errors;

    public AdGroupCriterionServiceErrorEntityFactory(List<Error> errors) {
        this.errors = errors;
    }
