...
import jp.yahooapis.ss.V5.CampaignTargetService.ErrorDetail;

public class CampaignTargetServiceErrorEntityFactory implements ErrorEntityFactory {

    private final List<Error> errors;


    public CampaignTargetServiceErrorEntityFactory(List<Error> errors) {
        this.errors = errors;
    }
