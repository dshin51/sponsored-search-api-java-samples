...
import jp.yahooapis.ss.V5.TrafficEstimatorService.ErrorDetail;

public class TrafficEstimatorServiceEntityFactory implements ErrorEntityFactory {

    private final List<Error> errors;


    public TrafficEstimatorServiceEntityFactory(List<Error> errors) {
        this.errors = errors;
    }
