...
import jp.yahooapis.ss.V5.AdGroupBidMultiplierService.ErrorDetail;
import jp.yahooapis.ss.V5.AdGroupBidMultiplierService.Error;

public class AdGroupBidMultiplierServiceErrorEntityFactory implements ErrorEntityFactory {

    private final List<Error> errors;

    public AdGroupBidMultiplierServiceErrorEntityFactory(List<Error> errors) {
        this.errors = errors;
    }
