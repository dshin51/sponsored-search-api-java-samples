...
import jp.yahooapis.ss.V5.CustomerSyncService.ErrorDetail;
import error.ErrorDetailEntity;
import error.ErrorEntity;
import error.ErrorEntityFactory;

public class CustomerSyncServiceErrorEntityFactory implements ErrorEntityFactory {

    private final List<Error> errors;

    public CustomerSyncServiceErrorEntityFactory(List<Error> errors) {
        this.errors = errors;
    }
